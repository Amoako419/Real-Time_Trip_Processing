            ...
            for item in response.get('Items', []):
                ...
                for key, value in item.items():
                    if 'S' in value:
                        ...
                        processed_item[key] = float(value['N']) # Convert Number to float
                ...
                processed_item['pickup_datetime'] = processed_item.get('pickup_datetime')
...
if __name__ == "__main__":
    ...
    try:
        ...
        if 'pickup_datetime' not in df.columns or 'fare_amount' not in df.columns or 'trip_id' not in df.columns:
             print("Error: Required columns ('pickup_datetime', 'fare_amount', 'trip_id') not found in DataFrame.")
             exit()
